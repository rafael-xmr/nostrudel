...
const Monero = createIcon({
	...
	viewBox: "0 0 48 48",
	path: [
		<Fragment key="WB2PwxTQsB8lfLfbsFSI4_3s5uJPNeoda4">
			<radialGradient
			...
			<path
				...
				fill="url(#WB2PwxTQsB8lfLfbsFSI4a_3s5uJPNeoda4_gr1)"
			...
			<path
				...
				fill="url(#WB2PwxTQsB8lfLfbsFSI4b_3s5uJPNeoda4_gr2)"
			...
			<path
				...
				fill="url(#WB2PwxTQsB8lfLfbsFSI4c_3s5uJPNeoda4_gr3)"
