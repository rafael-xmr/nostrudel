...
import type { ReplaceableLoader, SingleEventLoader, UserSetsLoader } from "applesauce-loaders";
...
export const GlobalProviders = ({
  ...
  const [singleEventLoader, setSingleEventLoader] = useState<SingleEventLoader>();
  ...
  useEffect(() => {
    ...
    getSingleEventLoader().then(
      (singleEventLoader) => singleEventLoader && setSingleEventLoader(singleEventLoader),
    );
  }, [rxNostr]);
