...
export default function MessagesSettings() {
	...
	const defaultMessageExpirationTime = useObservableEagerState(
	...
	return (
		<SimpleView gap="8" title="Messages" maxW="4xl">
			...
			<FormControl>
				<FormLabel htmlFor="messageExpiration">
				...
				<Select
					...
					onChange={(e) => {
						...
						localSettings.defaultMessageExpiration.next(
				...
				<FormHelperText>
					Set a default expiration time for new messages. Messages will
					automatically be deleted after this time.
				</FormHelperText>
			</FormControl>
