...
import type { NotificationChannel } from "@satellite-earth/core/types/control-api/notifications.js";
...
export default function NtfyNotificationSettings() {
	const { bakery$, controlApi$ } = useBakeryProvider();
	...
	return (
		<>
			...
			<Text>
				Ntfy notifications use an external app to send notifications to your
				device. you can find instructions on setting up the app{" "}
