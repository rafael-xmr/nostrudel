...
import {
	addRelayModeToMailbox,
	removeRelayModeFromMailbox,
} from "../../../helpers/nostr/mailbox";
...
function RelayLine({
	...
	mode,
	list,
}: { relay: string; mode: RelayMode; list?: NostrEvent }) {
...
function MailboxesPage() {
	...
	return (
		...
		>
			...
			<Text fontStyle="italic" mt="-2">
				moStard will always publish to these relays so other users can find your
				notes
			</Text>
