...
import { createRxOneshotReq, type EventPacket, type RxNostr } from "rx-nostr";
...
export function createSearchAction(
	relays?: string[],
	rxNostr?: RxNostr,
): (filters: Filter[]) => Observable<EventPacket> {
...
export default function SearchResults({
	...
	const search = useMemo(
		() => createSearchAction(relay ? [relay] : [], rxNostr),
		[rxNostr, relay],
	);
