...
import type WebRtcRelayClient from "../../../../classes/webrtc/webrtc-relay-client";
import type WebRtcRelayServer from "../../../../classes/webrtc/webrtc-relay-server";
...
export default function Connection({
	...
	const requestEvents = async () => {
		...
		const sub = client.subscribe(
			[{ authors: getPubkeysFromList(contacts).map((p) => p.pubkey) }],
			{
				onevent: (event) => {
