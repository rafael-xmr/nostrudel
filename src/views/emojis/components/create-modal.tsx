...
import { type EventTemplate, kinds } from "nostr-tools";
...
export default function EmojiPackCreateModal({
	onClose,
	...props
	...
	const submit = handleSubmit(async (values) => {
		...
		if (pub)
			navigate(
				`/emojis/${relayHintsManagement.getSharableEventAddress(pub.event)}`,
			);
	});
