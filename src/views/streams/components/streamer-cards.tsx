...
import { StreamCardsQuery, STREAMER_CARD_TYPE } from "../../../models/stream";
...
export default function StreamerCards({
	pubkey,
	...props
}: Omit<CardProps, "children"> & { pubkey: string }) {
	const contextRelays = useAdditionalRelayContext();
	const { eventStoreManagement, loadersManagement } = useLocalSettings();

	const cards = useEventModel(StreamCardsQuery, [
		{ pubkey, relays: contextRelays },
