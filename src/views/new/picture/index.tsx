...
import type { FileMetadata } from "applesauce-core/helpers";
...
import PicturePostForm, { type FormValues } from "./picture-post-form";
...
export default function NewPictureView() {
	...
	const submit = async (values: FormValues) => {
		...
		let draft = await factory.create(
		...
		navigate(
			`/pictures/${relayHintsManagement.getSharableEventAddress(signed)}`,
		);
	};
