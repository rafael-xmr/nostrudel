import { ButtonGroup, Flex, type FlexProps, useToast } from "@chakra-ui/react";
...
import { MagicInput, type RefType } from "../../../components/magic-textarea";
...
export default function RelayChatMessageForm({
	...
	const sendMessage = handleSubmit(async (values) => {
		...
		const result = await relayPoolManagement.pool.relay(relay).publish(signed);

		if (result.ok) eventStoreManagement.eventStore.add(signed);
		toast({
