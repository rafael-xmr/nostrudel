	...
	return (
		!!metadata && (
			<Alert status="warning" flexWrap="wrap">
				There are many jurisdictions where Torrenting is illegal, You should
				probably not use your personal nostr account.
				<Button
					onClick={createAnonAccount}
					variant="link"
					ml="auto"
					isLoading={loading}
				>
...
function TorrentsPage() {
	...
	const eventFilter = useCallback(
		(e: NostrEvent) => {
			...
			if (tags.length > 0 && tags.some((t) => !e.tags.some((e) => e[1] === t)))
				return false;
			return true;
		},
