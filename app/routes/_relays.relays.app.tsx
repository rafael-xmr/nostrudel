...
import AddRelayForm from "../../src/views/settings/relays/add-relay-form";
import {
	useReadRelays,
	useWriteRelays,
} from "../../src/hooks/use-client-relays";
import { useActiveAccount } from "applesauce-react/hooks";
import RelayControl from "../../src/views/settings/relays/relay-control";
import { getRelaysFromExt } from "../../src/helpers/nip07";
import { useUserDNSIdentity } from "../../src/hooks/use-user-dns-identity";
import useUserContactRelays from "../../src/hooks/use-user-contact-relays";
import { safeRelayUrls } from "../../src/helpers/relay";
import HoverLinkOverlay from "../../src/components/hover-link-overlay";
import SimpleView from "../../src/components/layout/presets/simple-view";
import { addAppRelay, RelayMode } from "../../src/services/app-relays";
import useUserMailboxes from "../../src/hooks/use-user-mailboxes";
import localSettings from "../../src/services/preferences";
